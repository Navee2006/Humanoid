...
// IPC Handlers for 3D file saving
ipcMain.handle('save-3d-file', async (event, defaultName) => {
    const result = await dialog.showSaveDialog(mainWindow, {
        title: 'Save 3D Model',
        defaultPath: defaultName || 'model.ply',
        filters: [
            { name: '3D Point Cloud', extensions: ['ply'] },
            { name: '3D Mesh (OBJ)', extensions: ['obj'] },
            { name: '3D Mesh (STL)', extensions: ['stl'] },
