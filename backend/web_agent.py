...
# Don't raise error at import time - check when WebAgent is instantiated instead
...
class WebAgent:
    def __init__(self):
        if not API_KEY:
            print("[WEB_AGENT] Warning: GEMINI_API_KEY not set. Web agent will not function.")
            self.client = None
        else:
