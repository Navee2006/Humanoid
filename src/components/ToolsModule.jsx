            ...
            <div className="flex justify-center gap-6 relative z-10">
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${!isConnected
                        ...
                        : isMuted
                            ...
                            : 'border-purple-500 bg-purple-500/10 text-purple-500 hover:bg-purple-500/20 shadow-[0_0_15px_rgba(147,51,234,0.3)]'
                        } `}
                >
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${isVideoOn
                        ...
                        : 'border-purple-900 text-purple-700 hover:border-purple-500 hover:text-purple-500'
                        } `}
                >
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all ${showSettings ? 'border-purple-400 text-purple-400 bg-purple-900/20' : 'border-purple-900 text-purple-700 hover:border-purple-500 hover:text-purple-500'
                        } `}
                >
                    <Settings size={24} />
                </button>
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${showPrinterWindow
                        ...
                        : 'border-purple-900 text-purple-700 hover:border-green-500 hover:text-green-500'
                        } `}
                >
                    <Printer size={24} />
                </button>
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${showCadWindow
                        ? 'border-purple-400 bg-purple-400/10 text-purple-400 hover:bg-purple-400/20 shadow-[0_0_15px_rgba(168,85,247,0.3)]'
                        : 'border-purple-900 text-purple-700 hover:border-purple-500 hover:text-purple-500'
                        } `}
                >
                    <Box size={24} />
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${showBrowserWindow
                        ...
                        : 'border-purple-900 text-purple-700 hover:border-blue-500 hover:text-blue-500'
                        } `}
                >
                    <Globe size={24} />
                </button>
